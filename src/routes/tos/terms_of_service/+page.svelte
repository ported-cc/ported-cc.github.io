...
<svelte:head>
  <title>Terms of Service | CCPorted</title>
</svelte:head>
...
<div class="terms-of-service-container">
  ...
  <div class="container">
    ...
    <section>
      <h2>Eligibility</h2>
      <p>
        To use our services, you must be at least 13 years of age. By using our
    ...
    <section>
      ...
      <p>
        ...
        availability, or functionality of our services.
      </p>
      <p>You acknowledge and agree that:</p>
      <ul>
        <li>The service may contain bugs, errors, or other limitations</li>
        <li>
          The availability of the service may be interrupted or discontinued at
          any time
        </li>
        <li>
          We may modify, update, or change the service at any time without
          notice
        </li>
        <li>
          We have no obligation to provide support or maintenance for the
          service
        </li>
      </ul>
    </section>
    ...
    <section>
      ...
      <ul>
        ...
        <li>Damages resulting from service interruption or system failures</li>
    ...
    <section>
      ...
      <ul>
        ...
        <li>Introduce malicious code or attempt to harm the service</li>
        <li>
